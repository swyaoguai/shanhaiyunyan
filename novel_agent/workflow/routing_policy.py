    ...
    def default(cls) -> "RoutingPolicy":
        return cls(
            rules=[
                ...
                RouteRule("chapter_settings", stage="project_ready", preferred_agent_name="ChapterSettingBuilder", required_context_keys=["project_dir", "outline_rows"]),
                ...
                RouteRule("chapter_settings", preferred_agent_name="ChapterSettingBuilder"),
